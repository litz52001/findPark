...
public class FindParkAdapter extends BaseAdapter{

	private Context mContext;
	public List<ParkBean> parkList;
	
	public FindParkAdapter(Context context,List<ParkBean> parkList) {
	...
	@Override
	public int getCount() {
		return parkList.size()>0 ? parkList.size():0;
	}

	@Override
	public Object getItem(int arg0) {
		return parkList.get(arg0);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ParkBean item = parkList.get(position);
		ViewHolder viewHolder = null;
		
		 if(convertView == null)
		 {
			 convertView = LayoutInflater.from(mContext).inflate(
						R.layout.act_findpark_item, null);
